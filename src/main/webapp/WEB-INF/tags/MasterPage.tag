...
<head>
    ...
    <script src="<c:url value="/js/libs/jquery/jquery.min.js"/>" type="text/javascript"></script>
    <script src="<c:url value="/js/libs/d3/d3.v3.js"/>" type="text/javascript"></script>
    <script src="<c:url value="/js/libs/nvd3/nv.d3.min.js"/>" type="text/javascript"></script>         
    ...
    <script src="<c:url value="/js/libs/jquery-noty/jquery.noty.min.js"/>"></script>     
    <script src="<c:url value="/js/libs/underscore.js/underscore-min.js"/>"></script>  
    <script>
        function formSubmit() {
